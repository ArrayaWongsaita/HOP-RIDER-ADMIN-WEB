...
//   ChatBubbleLeftEllipsisIcon,
// } from "@heroicons/react/24/outline";
// import { useSearchParams } from "react-router-dom"; // เพิ่มการ import useSearchParams
...
//   const messagesEndRef = useRef(null);
//   const dropdownRef = useRef(null);
//   const [searchParams, setSearchParams] = useSearchParams(); // เพิ่ม useSearchParams
...
//     // ตั้งค่า currentChat จาก query parameters
//     const chatType = searchParams.get("type") || "rider";
//     const chatId = searchParams.get("id") || 1;
//     setCurrentChat({ type: chatType, id: Number(chatId) });
//   }, []);
...
//     setSearchParams({ type: type, id: nextChatId });
//   };
